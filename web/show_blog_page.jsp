...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v6.0"></script>
    ...
    <a class="navbar-brand" href="index.jsp"><span class="fa fa-cube"></span>TechBlog</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
       ...
       <li class="nav-item">
        <a class="nav-link" href="#"><span class="fa fa-phone-square"></span>Contacts</a>
      </li>
        <li class="nav-item">
                      ...
                      <div class="card-footer">
                          ...
                          <a href="#!" class="btn btn-outline-primary btn-sm"><i class="fa fa-commenting-o"></i><span>10</span></a>
                           ...
                           <div class="card-footer">
                               ...
                               <div class="fb-comments" data-href="http://localhost:9494/TechBlog/show_blog_page.jsp?post_id=<%= p.getPid() %>" data-width="" data-numposts="10"></div>
    ...
    <div id="profile-edit" style="display:none">
        ...
        <form action="EditServlet" method="post" enctype="multipart/form-data">
            <table class="table" >
                ...
                <tr>
                    <td>About :</td>
                    <td><textarea rows="2" class="form-control" name="about"> <%= user.getAbout() %></textarea></td>
                </tr>
                <br>
                <tr>
                ...
                <br>
                        ...
                        <div class="container">
                            <button type="submit" class="btn btn-outline-light bg-dark">Save</button>
                        </div>
...
<div class="modal fade" id="add-post-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <form id="add-post-form" action="AddPostServlet" method="post">
  ...
  <div class="form-group">
    ...
    <input type="text" name="pTitle" class="form-control" id="exampleFormControlInput1" placeholder="Title">
  </div>
  ...
  <div class="form-group">
    ...
    <textarea  name="pContent "class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
     <div class="form-group">
    <label for="exampleFormControlTextarea1">Enter Source Code</label>
    <textarea name="pCode"class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
    ...
    <input type="file" name="pic" class="form-control-file" id="exampleFormControlFile1">
      ...
      <div class="container text-center">
           <button type="submit" class="btn btn-outline-light bg-dark">Post</button>
         ...
         <script>
             $(document).ready(function(e){
                 ...
                 $("#add-post-form").on("submit",function(event){
                    ...
                    console.log("you have clicked on subm");
